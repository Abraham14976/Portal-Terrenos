...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "Proyecto residencial con servicios básicos listos, áreas verdes y acceso pavimentado. Ubicación estratégica en Polloc, Cajamarca. Ideal para construir tu casa o invertir con plusvalía asegurada.",
    longDescription:
      "Santa Margarita es un proyecto residencial ubicado en Polloc (Cajamarca), pensado para familias que buscan tranquilidad y plusvalía. Cuenta con todos los servicios básicos, vías pavimentadas, áreas comunes y cercanía a colegios, mercados y centros de salud.",
    ...
    features: [
      { title: "Servicios integrales", description: "Agua, luz y desagüe desde el día 1.", icon: "Zap" },
      { title: "Plusvalía garantizada", description: "Zona de crecimiento comercial.", icon: "TrendingUp" },
      { title: "Escrituración inmediata", description: "Títulos de propiedad individuales.", icon: "FileCheck2" },
    ],
    lots: generateLots("SM", 52, 120, 220, 57000, 148000),
    highlights: [
      "Precios desde S/ 57,000 soles",
      "Escritura pública y Sunarp al día",
      "Calles pavimentadas y alumbrado público",
      "Visita guiada SÍ o SÍ con Abraham Portal",
      "Entrega inmediata, sin meses de espera",
  ...
  },
  {
    ...
    description:
      "Proyecto residencial familiar con amplias áreas verdes, piscina y zona de recreación infantil. Alameda La Colpa combina diseño y calidad de vida en Cajamarca.",
    longDescription:
      "Alameda La Colpa es un proyecto residencial de alta gama pensado en el bienestar familiar. Con más de 5 hectáreas de áreas verdes, piscina semi-olímpica, gimnasio al aire libre y acceso controlado 24/7.",
    ...
    features: [
      { title: "Club house", description: "Amplias áreas sociales para eventos.", icon: "Users" },
      { title: "Zonas verdes", description: "Más de 5 hectáreas de parques.", icon: "Leaf" },
      { title: "Seguridad privada", description: "Acceso controlado las 24 horas.", icon: "ShieldCheck" },
    ],
    lots: generateLots("AC", 58, 140, 280, 89000, 212000),
    highlights: [
      "Piscina semi-olímpica para toda la familia",
      "Cancha multideportiva y juegos infantiles",
      "Seguridad privada 24 horas con control de acceso",
      "Avenida principal de 18 m de ancho pavimentada",
      "Títulos de propiedad individuales Sunarp",
      "Visita guiada todos los días con Abraham",
    ],
    type: "Mixto",
  },
  {
